...
| MA | Massachusetts Register (Secretary of the Commonwealth) | Biweekly (Fri) | Register paywalled ($225/yr) — but the notice section is FREE on the Secretary's site | None | No | 21 days' notice (M.G.L. c.30A §§ 2–3) | MODERATE¹ |
...
| MS | Mississippi Administrative Bulletin (SOS) | Event-driven (≤2 business days after filing) | ASP.NET portal; docs at stable sequential `ACProposed/{id}{a,b}.pdf` URLs (Form 001s often scans) | None found *[email signup unverified]* | No | 25 days (Miss. Code Ann. § 25-43-3.106) | MOD-HARD¹ |
...
| NE | **No register** — SOS Proposed Rules Docket + newspaper notice | Continuous | CGI HTML + PDFs (**many image scans**) | Docket email subscription (incl. statewide) | Optional per-agency in tracking system | 30 days' hearing notice (Neb. Rev. Stat. § 84-907) | MOD-HARD¹ |
| NV | Nevada Register of Administrative Regulations (Legislative Counsel Bureau) | Rolling | Per-regulation text PDFs + dated DailyUpdates.htm index w/ typed suffixes | None; App/Notice system as 2nd source | No | 30 days' notice (NRS 233B.060) | MODERATE¹ |
...
| NJ | New Jersey Register (OAL, **published by LexisNexis**) | Semimonthly (1st & 3rd Mon) | LexisNexis viewer; OAL posts free section PDFs w/ parseable `PRN` filenames + Dynamics 365 proposals DB | Dept. listservs (DEP, DOH) | No | 30 days statutory, 60 days customary (N.J.S.A. 52:14B-4) | MOD-HARD¹ |
...
| TN | Rolling SOS filings — the official electronic register since 2009 (tnsos.org index) | Rolling (posted ≤7 days) | Sortable HTML index + text PDFs (enumerable `MM-SS-YY.pdf`) | None found | No | 45-day hearing notice window (T.C.A. § 4-5-203/204) *[cite unverified]* | MODERATE¹ |
...
¹ Rating revised July 2026 by the hard-states deep dive ([`hard-states.md`](hard-states.md)):
TN/NV/MA down to MODERATE, NE/MS/NJ to MOD-HARD; only GA and HI remain HARD.
